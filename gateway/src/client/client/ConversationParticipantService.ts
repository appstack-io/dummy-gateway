...
export interface ConversationParticipantFindByConversationResultMeta {
  ...
  export class ConversationParticipantService {
    ...
    async createOne(data: Partial<ConversationParticipantCreateOneInput>, metadata: Metadata=new Metadata()): Promise<ConversationParticipant> {
      return postToUnary<ConversationParticipant>(this.serviceName, 'createOne', data, metadata);
    }
    
    async createOnePublic(data: Partial<ConversationParticipantCreateOneInput>, metadata: Metadata=new Metadata()): Promise<ConversationParticipant> {
      return postToUnaryPublic<ConversationParticipant>(this.serviceName, 'createOne', data, metadata);
    }
    ...
    async findOne(data: Partial<ConversationParticipantFindOneInput>, metadata: Metadata=new Metadata()): Promise<ConversationParticipant> {
      return postToUnary<ConversationParticipant>(this.serviceName, 'findOne', data, metadata);
    }
    
    async findOnePublic(data: Partial<ConversationParticipantFindOneInput>, metadata: Metadata=new Metadata()): Promise<ConversationParticipant> {
      return postToUnaryPublic<ConversationParticipant>(this.serviceName, 'findOne', data, metadata);
    }
    ...
    async removeOne(data: Partial<ConversationParticipantRemoveOneInput>, metadata: Metadata=new Metadata()): Promise<ConversationParticipant> {
      return postToUnary<ConversationParticipant>(this.serviceName, 'removeOne', data, metadata);
    }
    
    async removeOnePublic(data: Partial<ConversationParticipantRemoveOneInput>, metadata: Metadata=new Metadata()): Promise<ConversationParticipant> {
      return postToUnaryPublic<ConversationParticipant>(this.serviceName, 'removeOne', data, metadata);
    }
    ...
    async findByConversation(data: Partial<ConversationParticipantFindByConversationInput>, metadata: Metadata=new Metadata()): Promise<ConversationParticipantFindByConversationResult> {
      return postToUnary<ConversationParticipantFindByConversationResult>(this.serviceName, 'findByConversation', data, metadata);
    }
    
    async findByConversationPublic(data: Partial<ConversationParticipantFindByConversationInput>, metadata: Metadata=new Metadata()): Promise<ConversationParticipantFindByConversationResult> {
      return postToUnaryPublic<ConversationParticipantFindByConversationResult>(this.serviceName, 'findByConversation', data, metadata);
    }
